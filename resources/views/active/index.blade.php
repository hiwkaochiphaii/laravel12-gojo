<x-active-bootstrap title="yedhee33">
        ...
        <div class="row align-items-center justify-content-between">
          ...
          <div class="col-lg-4 order-lg-1">
            ...
            <p class="mt-5" data-aos="fade-up">
              <a href="{{ asset('#') }}" class="btn btn-get-started">Get Started</a>
            </p>
          </div>
        </div>
      </div>
          ...
          <div class="row justify-content-center">
            ...
            <div class="offset-md-0 offset-lg-1 col-sm-12 col-md-5 col-lg-5 col-xl-4" data-aos="fade-up">
              <div class="px-3">
                ...
                <p>
                  <a href="{{ asset('#') }}" class="btn-get-started">Get Started</a>
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="row gy-4">
          <div class="col-md-6 col-lg-4">
            <div class="post-entry" data-aos="fade-up" data-aos-delay="100">
              <a href="{{ asset('#') }}" class="thumb d-block"><img src="{{ asset('assets/img/img_h_4.jpg') }}" alt="Image" class="img-fluid rounded"></a>

              <div class="post-content">
                <div class="meta">
                  <a href="{{ asset('#') }}" class="cat">Development</a> •
                  <span class="date">July 20, 2020</span>
                </div>
                <h3><a href="{{ asset('#') }}">There live the blind texts they live</a></h3>
                <p>
                  Far far away, behind the word mountains, far from the countries
          ...
          <div class="col-md-6 col-lg-4">
            <div class="post-entry" data-aos="fade-up" data-aos-delay="200">
              <a href="{{ asset('#') }}" class="thumb d-block"><img src="{{ asset('assets/img/img_h_2.jpg') }}" alt="Image" class="img-fluid rounded"></a>
          ...
          <div class="col-md-6 col-lg-4">
            <div class="post-entry" data-aos="fade-up" data-aos-delay="300">
              <a href="{{ asset('#') }}" class="thumb d-block"><img src="{{ asset('assets/img/img_h_3.jpg') }}" alt="Image" class="img-fluid rounded"></a>
      ...
      <div class="container">
        <div class="row gap-x-lg-4 justify-content-between">
          <div class="col-lg-4 js-custom-dots">
            <a href="{{ asset('#') }}" class="service-item link horizontal d-flex active" data-aos="fade-left" data-aos-delay="0">
            ...
            <a href="{{ asset('#') }}" class="service-item link horizontal d-flex" data-aos="fade-left" data-aos-delay="100">
            ...
            <a href="{{ asset('#') }}" class="service-item link horizontal d-flex" data-aos="fade-left" data-aos-delay="200">
            ...
            <a href="{{ asset('#') }}" class="service-item link horizontal d-flex" data-aos="fade-left" data-aos-delay="300">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="pricing-item">
              ...
              <div class="btn-wrap">
                <a href="{{ asset('#') }}" class="btn-buy">Buy Now</a>
              </div>
            </div>
